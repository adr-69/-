...
<div class="main-nav">
  <div class="container">
    ...
    <button class="dark-white" onclick="changeBG(this)">DARK</button>
  </div>
</div>
...
<div class="main-home" id="home">
  <div class="home-content">
    <h2>Hi! I'm</h2>
    <h1>Adrian Martin</h1>
    <h3>Front-End Developer | Ethical Hacker</h3>
    <br />
 ...
 <div class="main-project" id="project">
  ...
  <div class="left-project">
    ...
    <div class="box-project">
      ...
      <p>FOR CRUSH V2</p>
      <a href="https://adr-69.github.io/4crush/crushv2.html">LINK HERE</a>
      <a href="#"><button>DOWNLOAD CODE (1 FILE)</button></a>
    </div>
    ...
    <div class="box-project">
      ...
      <p>FOR CRUSH V3</p>
      <a href="https://adr-69.github.io/4crush/crushv3.html">LINK HERE</a>
      <a href="#"><button>DOWNLOAD CODE (1 FILE)</button></a>
    </div>
    ...
    <div class="box-project">
      ...
      <p>FOR CRUSH V4</p>
      <a href="https://adr-69.github.io/4crush/crushv4.html">LINK HERE</a>
      <a href="#"><button>DOWNLOAD CODE (1 FILE)</button></a>
    </div>
    
    <div class="box-project">
      <img class="project-logo" src="grpimage/projectIMG/customedittxt.jpeg" alt="CUSTOM EDIT TEXT" />
      <p>CUSTOM EDIT TEXT</p>
      <a href="" onclick="linkERROR()">LINK HERE</a>
      <a href="#"><button>DOWNLOAD CODE (1 FILE)</button></a>
    </div>
    
    <div class="box-project">
      <img class="project-logo" src="grpimage/projectIMG/forex.jpeg" alt="FOR UR EX" />
      <p>FOR UR EX</p>
      <a href="https://adr-69.github.io/4crush/ex.html">LINK HERE</a>
      <a href="#"><button>DOWNLOAD CODE (1 FILE)</button></a>
    </div>
    
    <div class="box-project">
      <img class="project-logo" src="grpimage/projectIMG/giftgame.jpeg" alt="GIFT GAME" />
      <p>GIFT GAME</p>
      <span>(I use Discord to receive notifications)</span>
      <a href="https://adr-69.github.io/4crush/giftv2.html">LINK HERE</a>
      <a href="#"><button>DOWNLOAD CODE (1 FILE)</button></a>
    </div>
    
    <div class="box-project">
      <img class="project-logo" src="grpimage/projectIMG/namamasko.jpeg" alt="NAMAMASKO" />
      <p>NAMAMASKO</p>
      <span>(I use Discord to receive notifications)</span>
      <a href="https://adr-69.github.io/namamasko/paskov1.html">LINK HERE</a>
      <a href="#"><button>DOWNLOAD CODE (1 FILE)</button></a>
    </div>
    
    <div class="box-project">
      <img class="project-logo" src="grpimage/projectIMG/MusicRandomPlay.jpeg" alt="MUSIC RANDOM PLAY" />
    ...
    <div class="box-project">
      ...
      <p>MY OWN NGL</p>
      <span>(I use Discord to receive notifications)</span>
      <a href="https://adr-69.github.io/sendkasakin/message.html">LINK HERE</a>
      <a href="#"><button>DOWNLOAD CODE (1 FILE)</button></a>
    </div>
  </div>
</div>
...
<div class="main-contact" id="contact">
    <div class="left-form">
      <h1>CONTACT</h1>
      <form action="backend/server.php" id="contactForm" method="POST">
